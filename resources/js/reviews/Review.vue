<template>
    <div>
        <success v-if="success">You've left a review, thank you!</success>
            ...
            <div :class="[{'col-md-8': twoColumns}, {'col-md-12': oneColumn}]">
                ...
                <div v-else>
                    ...
                    <div v-else>
                        ...
                        <div class="form-group">
                            <label for="content" class="text-muted">Describe your experience with Bookable</label>
                            <textarea 
                                name="content"
                                cols="30"
                                rows="10"
...
export default ({
    ...
    async created() {
        ...
        this.loading = true;
        // fetch review by id {store in existingReview}
